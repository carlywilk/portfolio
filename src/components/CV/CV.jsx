        ...
        <section className="cv">
            ...
            <section className="cv__main">
                <div className="cv__about">
                    ...
                    <p className="cv__about-me-content">As a software developer with a background in executive operations, I bring a unique blend of technical expertise and systems thinking; I thrive in mission-driven environments where technology and purpose intersect. My experience supporting high-level decision-makers has sharpened my critical thinking and adaptability skills, enabling me to design scalable workflows that reduce friction across teams. I'm committed to building accessible, user-centered solutions and strive to deliver equitable, impactful products rooted in care and consent.</p>
