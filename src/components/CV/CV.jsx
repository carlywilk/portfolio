        ...
        <section className="cv">
            ...
            <section className="cv__main">
                <div className="cv__about">
                    ...
                    <p className="cv__about-me-content">As a software developer with a background in biology, I bring a unique combination of technical expertise. My experience spans both web development and executive assistance, which has honed my ability to think critically, pay attention to detail, and adapt quickly to new challenges. My strong foundations in biology and sociology enhance my problem-solving skills, particularly in areas like data management and user-focused design.</p>
